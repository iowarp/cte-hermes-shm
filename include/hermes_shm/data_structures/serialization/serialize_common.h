...
struct has_serialize_fun<Ar, T, std::void_t<decltype(serialize(std::declval<Ar&>(), std::declval<T&>()))>>
: std::true_type {};
template <typename Ar, typename T>
...
template <typename Ar, typename T>
struct has_save_fun<Ar, T, std::void_t<decltype(save(std::declval<Ar&>(), std::declval<const T&>()))>>
    : std::true_type {};
template <typename Ar, typename T>
...
struct has_serialize_cls<Ar, CLS, std::void_t<decltype(std::declval<CLS>().template serialize<Ar>(std::declval<Ar&>()))>>
: std::true_type {};
template <typename Ar, typename CLS>
...
template <typename Ar, typename CLS>
struct has_load_cls<Ar, CLS, std::void_t<decltype(std::declval<CLS>().template load<Ar>(std::declval<Ar&>()))>>
    : std::true_type {};
template <typename Ar, typename CLS>
