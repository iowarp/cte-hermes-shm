...
#define HERMES_IPC_MANAGER scs::GlobalSingleton<hermes_shm::IpcManager>::GetInstance()
#define HERMES_IPC_MANAGER_T hermes_shm::IpcManager*

#define HERMES_CONFIGURATION_MANAGER scs::GlobalSingleton<hermes_shm::ConfigurationManager>::GetInstance()
