...
#define HERMES_SYSTEM_INFO scs::GlobalSingleton<hermes_shm::SystemInfo>::GetInstance()
#define HERMES_SYSTEM_INFO_T hermes_shm::SystemInfo*

#define HERMES_MEMORY_REGISTRY scs::GlobalSingleton<hermes_shm::ipc::MemoryRegistry>::GetInstance()
#define HERMES_MEMORY_REGISTRY_T hermes_shm::ipc::MemoryRegistry*

#define HERMES_MEMORY_MANAGER scs::GlobalSingleton<hermes_shm::ipc::MemoryManager>::GetInstance()
#define HERMES_MEMORY_MANAGER_T hermes_shm::ipc::MemoryManager*

#define HERMES_THREAD_MANAGER scs::GlobalSingleton<hermes_shm::ThreadManager>::GetInstance()
