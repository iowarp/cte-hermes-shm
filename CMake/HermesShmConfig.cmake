...
option(HERMES_RPC_THALLIUM @HERMES_RPC_THALLIUM@)
option(HERMES_ENABLE_PTHREAD @HERMES_ENABLE_PTHREAD@)
option(HERMES_ENABLE_OPENMP @HERMES_ENABLE_OPENMP@)
option(HERMES_ENABLE_CEREAL @HERMES_ENABLE_CEREAL@)
option(HERMES_ENABLE_COVERAGE @HERMES_ENABLE_COVERAGE@)
option(HERMES_ENABLE_DOXYGEN @HERMES_ENABLE_DOXYGEN@)
option(HERMES_CXX_PROFILE  @HERMES_CXX_PROFILE@)
option(HERMES_ENABLE_PTHREADS @HERMES_ENABLE_PTHREADS@)
option(HERMES_DEBUG_LOCK @HERMES_DEBUG_LOCK@)
option(HERMES_ENABLE_PROFILING @HERMES_ENABLE_PROFILING@)
option(HERMES_ENABLE_COMPRESS @HERMES_ENABLE_COMPRESS@)
option(HERMES_ENABLE_ENCRYPT @HERMES_ENABLE_ENCRYPT@)
option(HERMES_USE_ELF @HERMES_USE_ELF@)
option(HERMES_ENABLE_CUDA @HERMES_ENABLE_CUDA@)
