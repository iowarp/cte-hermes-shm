"""
LightBeam Client Package for Jarvis
"""
from jarvis_cd.basic.pkg import Application
from jarvis_util import *


class LightbeamClient(Application):
    def _init(self):
        pass
    ...
    def _configure_menu(self):
        return [
            ...
            {
                'name': 'ITERATIONS',
                'msg': 'Number of benchmark iterations',
                'type': int,
                'default': 1000,
            },
            {
                'name': 'MESSAGE_SIZE',
                'msg': 'Message size in bytes',
                'type': int,
                'default': 64,
            },
            {
    ...
    def stop(self):
        try:
            Exec("pkill -f lightbeam_client_unit_test", LocalExecInfo(env=self.env))
        except:
            pass
